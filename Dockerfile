...
USER root
RUN apt-get update && \
    apt-get install -y apparmor fetchmail procmail uudeview apt-transport-https p7zip-full ca-certificates rsync yum-utils createrepo build-essential unzip debmirror ubuntu-archive-keyring && \
